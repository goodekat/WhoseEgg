...
- Manuscript: 
  - **Create an outline**
    ...
    - Emphasize the need to make the model more broadly available via the app
    - Intro: explaining identification of carp eggs and fish eggs in general 
...
- Other:
  - **List app authors/contributors some where (me, Mike, Philip, and Carlos)**
