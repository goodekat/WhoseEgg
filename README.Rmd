...
- **Change the way in which the data and predictions are stored (join them in one large data frame, which will be easier to export) and then adjust other code as necessary**
