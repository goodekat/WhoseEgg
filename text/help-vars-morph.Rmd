...
<img src="../www/membrane-diameter.jpeg" height="200">

<hr/>

#### **Average of Yolk Diameters**

**Definition**: The average of four diameter measurements (mm) taken from the yolk with starting points that were equally spaced around the circumference as defined by Kelso and Rutherford (1996).
...
The images below show examples of four equally spaced yolk diameter measurements.

<img src="../www/yolk-diameter.jpeg" height="200">
...
Examples of compact eggs: The yolk entity is clearly identifiable. Note that it is difficult to see the identifiable yolk of the egg in the top right corner. When the egg was viewed under a microscope, the yolk would roll around within the membrane. If you look closely at the right side of the yolk, you can see the space between the yolk and membrane. The yolk is compact but nearly as big as the membrane.

<img src="../www/compact.jpeg" width="800">
...
<img src="../www/diffuse.jpeg" width="800">
...
<img src="../www/pigment.jpeg" width="800">

Examples of eggs without pigment. There are no chromatophores present.

<img src="../www/no-pigment.jpeg" width="800">
...
**Additional Information**: Below are examples of the stages. Most of these pictures of the stages are not be great representations. Assessing the stage is accomplished best with the egg under a microscope, so that it can be moved around to inspect all sides and angles.
...
<img src="../www/egg-stage-1.jpeg" height="400">

Egg Stage 2 (morula): The arrows point to blastomeres.

<img src="../www/egg-stage-2.jpeg" height="200">

Egg Stage 3 (blastula):

<img src="../www/egg-stage-3.jpeg" height="200">

Egg Stage 4 (gastrula): The arrow points to germ ring

<img src="../www/egg-stage-4.jpeg" height="200">

Egg Stage 5 (early yolk): The arrows point to yolknic axis (spine and back forming). This is best described as a ridge line that sticks out of the yolk.

<img src="../www/egg-stage-5.jpeg" height="200">

Egg Stage 6 (tail-bud stage): Out of the yolknic axis, the head and tail will form a rounded end. The tail will start to protrude away from the yolk.

<img src="../www/egg-stage-6.jpeg" height="200">

Egg Stage 7 (tail-free stage): The tail continues to protrude away from yolk and is now not touching the yolk. The arrows point to the tail not touching the yolk.

<img src="../www/egg-stage-7.jpeg" height="200">

Egg Stage 8 (late yolk): The yolk is almost fully developed. Myomeres, eyes, auditory vesicle are all present. The egg is close to hatching.

<img src="../www/egg-stage-8.jpeg" height="200">

<hr/>

#### **Larval Length**

**Definition**: Total length measurement (mm) along the midline from all of the late stage yolks (eggs in stages 6-8)
...
<img src="../www/larval-length.jpeg" height="200">
...
<img src="../www/sticky-debris.jpeg" height="400">

Examples of eggs without sticky debris. There is no debris or sand on the membranes.

<img src="../www/no-sticky-debris.jpeg" height="400">

<hr/>

#### **Yolk to Membrane Ratio**

**Definition**: The ratio of average yolk diameter to average membrane diameter:
