...
1. A **probability** for each response variable level: In the example below, the probability for species 1 is 2/3 since two of the three trees returned a prediction of species 1. 
2. A **prediction**: In the example below, the prediction is species 1 since it is the species with the highest random forest probability.
