...
See the **Table of Predictions** below for the taxonomic levels returned with the highest random forest probabilities for each fish egg. The columns of Family Pred, Genus Pred, and Species Pred contain the taxonomy level with the highest random forest probability. The columns of Family Prob, Genus Prob, and Species Prob contain the corresponding random forest probability. 
